document.addEventListener("DOMContentLoaded", () => {
    ...
    document.querySelector("#linkCreateAccount").addEventListener("click", e => {
        ...
        alert("Before making an account please make sure your password starts with uppercase character, contains at least 1 special character, lowercase character and doesn't include any spaces")
    });
...
function validation_sign(){
    ...
    if(result2 == true && (first2 >= 65 && first2 <= 90) && special(password2) == true && length2 >= 8 && password2.includes(" ") == false && phonel == 11){
        if(document.getElementById('male').checked) {
            ...
            alert("please make sure your password starts with uppercase character, contains at least 1 special character, lowercase character and doesn't include any spaces")
            e.preventDefault();
            window.location = "index.html";
        }
